...
from sqlalchemy import String, Numeric, Date, Boolean, DateTime, ForeignKey, Index, CheckConstraint
...
class Transaction(Base, UUIDMixin, TimestampMixin):
    ...
    __table_args__ = (
        CheckConstraint("transaction_type IN ('expense', 'income', 'transfer')", name="ck_transaction_type"),
